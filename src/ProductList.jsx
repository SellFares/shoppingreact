...
function ProductList({ onHomeClick }) {
    ...
    const itemsSelected = useSelector(s => s.cart.items);
    const plantsArray = [
        {
    ...
    console.log("Local AddedtoCart", addedToCart);
    console.log("Local AddedtoCart length", Object.keys(addedToCart).length);
                ...
                <div style={styleObjUl}>
                    ...
                    <div> <a href="#" onClick={(e) => handleCartClick(e)}
                        style={styleA}><h1 className='cart'>
                            ...
                            <span className='cart_quantity_count'>{itemsSelected.length}</span>
                                ...
                                {category.plants.map((plant, plantIndex) => (
                                    <div className="product-card" key={plantIndex}>
                                        ...
                                        <button className='product-button'
                                            disabled={itemsSelected.find(i => i.name == plant.name) ? 'true' : ''}
                                            style={
                                                {
                                                    cursor: itemsSelected.find(i => i.name == plant.name) ? 'not-allowed' : '',
                                                    backgroundColor: itemsSelected.find(i => i.name == plant.name) ? 'grey' : ''
                                                }
                                            }
